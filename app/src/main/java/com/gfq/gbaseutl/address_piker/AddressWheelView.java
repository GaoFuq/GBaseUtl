...
import java.util.concurrent.TimeUnit;
  ...
  class AddressWheelView extends View {
    ...
    public AddressWheelView(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.AddressWheelView, 0, 0);
            mGravity = a.getInt(R.styleable.AddressWheelView_gravity, Gravity.CENTER);
            textColorOut = a.getColor(R.styleable.AddressWheelView_textColorOut, 0xFFa8a8a8);
            textColorCenter = a.getColor(R.styleable.AddressWheelView_textColorCenter, 0xFF333333);
            dividerColor = a.getColor(R.styleable.AddressWheelView_dividerColor, 0xFFd5d5d5);
//            CenterBackground = a.getColor(R.styleable.WheelView_centerBackground, 0xFFffffff);
            CenterBackground = Color.parseColor("#ffffff");
            textSize = a.getDimensionPixelOffset(R.styleable.AddressWheelView_textSize, sp2px(context, 16));
            lineSpacingMultiplier = a.getFloat(R.styleable.AddressWheelView_lineSpacingMultiplier, 3.0F);
            isLoop = a.getBoolean(R.styleable.AddressWheelView_isLoop, false);
            initPosition = a.getInt(R.styleable.AddressWheelView_initPosition, -1);
            visibleItemCount = a.getInt(R.styleable.AddressWheelView_visibleItemCount, 7);
            a.recycle();//回收内存
        }
    ...
    private void initPaints() {
        ...
        paintCenterText.setStyle(Paint.Style.FILL);
