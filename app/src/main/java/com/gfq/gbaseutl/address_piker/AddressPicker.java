...
public class AddressPicker extends Dialog implements View.OnClickListener{
    ...
    private void initView() {
        mViewProvince = (AddressWheelView) view.findViewById(R.id.wv_province);
        mViewCity = (AddressWheelView) view.findViewById(R.id.wv_city);
        mViewDistrict = (AddressWheelView) view.findViewById(R.id.wv_district);
