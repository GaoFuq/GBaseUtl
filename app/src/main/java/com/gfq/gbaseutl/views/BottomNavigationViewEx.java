 ...
 *
 * 禁止所有动画
 * xxx.setEnableSwitchAnimation(false); 去掉切换动画
 * xxx.setEnableShiftingMode(false); 去掉位移动画
 * xxx.setEnableItemShiftingMode(false); 去掉放大动画
...
public class BottomNavigationViewEx extends BottomNavigationView {
     ...
     */
    public void setEnableSwitchAnimation(boolean enable) {
        /*
        1. get field in this class
        private final BottomNavigationMenuView mMenuView;
     ...
     */
    public void setEnableItemShiftingMode(boolean enable) {
        /*
        1. get field in this class
        private final BottomNavigationMenuView mMenuView;
    ...
    public void enableShiftingMode() {
