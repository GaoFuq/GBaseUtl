package com.gfq.gbaseutl.views.wheelview;
...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
        ...
        textSize = getResources().getDimensionPixelSize(R.dimen.wheelview_textsize);//默认大小
        ...
        if (attrs != null) {
            ...
            textColorCenter = a.getColor(R.styleable.AddressWheelView_textColorCenter, 0xFF2a2a2a);
            dividerColor = a.getColor(R.styleable.AddressWheelView_dividerColor, 0xFFd5d5d5);
            textSize = a.getDimensionPixelOffset(R.styleable.AddressWheelView_textSize, textSize);
            lineSpacingMultiplier = a.getFloat(R.styleable.AddressWheelView_lineSpacingMultiplier, lineSpacingMultiplier);
            a.recycle();//回收内存
        }
