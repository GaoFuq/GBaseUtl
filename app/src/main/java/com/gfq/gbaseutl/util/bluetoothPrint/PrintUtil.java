...
public class PrintUtil {
    ...
    public static void printOne(BluetoothSocket bluetoothSocket, String msg) {
        try {
    ...
    public static void printTwo(BluetoothSocket bluetoothSocket, String msg1, String msg2) {
        try {
            PrintUtil pUtil = new PrintUtil(bluetoothSocket.getOutputStream(), "GBK");
            pUtil.printAlignment(0);
            pUtil.printTwoColumn(msg1,msg2);
            pUtil.printLine();
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public static void printThree(BluetoothSocket bluetoothSocket, String msg1, String msg2, String msg3) {
        try {
            PrintUtil pUtil = new PrintUtil(bluetoothSocket.getOutputStream(), "GBK");
            pUtil.printAlignment(0);
            pUtil.printTabSpace(1);
            pUtil.printThreeColumn(msg1,msg2,msg3);
            pUtil.printLine();
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public static void printTest(BluetoothSocket bluetoothSocket, Bitmap bitmap) {
        ...
        try {
            ...
            // 店铺名 居中 放大
            pUtil.printAlignment(0);
            pUtil.printText("XXX工作面");
            pUtil.printLine();
            pUtil.printAlignment(0);
            pUtil.printLine();

            pUtil.printTwoColumn("2019年02月05日", "早班");
            pUtil.printLine();

            pUtil.printText("K1值");
            pUtil.printLine();

            pUtil.printThreeColumn("孔号", "位置","值");
            pUtil.printLine();

            pUtil.printThreeColumn("1", "2","0.2");
            pUtil.printLine();

            pUtil.printText("结论:");

            pUtil.printText("K1max=0.2,Smax=3");
            pUtil.printLine();
