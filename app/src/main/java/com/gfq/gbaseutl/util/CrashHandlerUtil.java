    ...
    private boolean handleException(final Throwable throwable) {
        ...
        new Thread() {
            ...
            public void run() {
                ...
                //Toast.makeText(mContext,  ExceptionHandle.handleException(throwable).message, Toast.LENGTH_LONG).show();
                Looper.loop();
            }
        }.start();
        //收集设备参数信息
        ...
        String file = saveCrashInfo2File(throwable);
        //上传文件到服务器
        return true;
    }
    ...
    private String saveCrashInfo2File(Throwable ex) {
        ...
        try {
            ...
            if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
                String path = Environment.getExternalStorageDirectory().getPath() + "/yaguCaches/crash/";
